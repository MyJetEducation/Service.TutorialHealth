...
using Service.TutorialHealth.Modules;
using Service.TutorialHealth.Services;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.TutorialHealth
{
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			{
				endpoints.MapGrpcSchema<TutorialHealthService, ITutorialHealthService>();
